...
SECRET_KEY = 'django-insecure-i&z&yqvr6rr5mt&^eml*9epqyxby65!^cum*-2!&99s#-er9p3'
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:5173",  # Your React/Vite origin
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': 'yogesh6625',           # Your MySQL password
